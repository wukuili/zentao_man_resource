...
<style>
#mainMenu {border-bottom: 1px solid #eee; padding: 10px 20px; background: #fff;}
#mainMenu .input-control {margin-bottom: 0;}
.main-table {padding: 20px;}
</style>
<div id="mainContent" class="main-content">
  <div id='mainMenu' class='clearfix'>
  <div class='btn-toolbar pull-left'>
    <form method='post' action='<?php echo inlink('orgdimension');?>'>
      <div class='input-control'>
        <span class='form-name'><strong><?php echo $lang->man_resource->dept;?></strong></span>
        <?php echo html::select('depts[]', $deptPairs, $depts, "class='form-control picker-select' multiple");?>
      </div>
      <div class='input-control'>
        <span class='form-name'><strong><?php echo $lang->man_resource->role;?></strong></span>
      ...
      <?php if(common::hasPriv('man_resource', 'exportCompany')) echo html::a(inlink('exportCompany', "begin=" . strtotime($begin) . "&end=" . strtotime($end) . "&mode=$status"), "<i class='icon-export'></i> " . $lang->export, '', "class='btn btn-link iframe' data-width='600px'");?>
...
<div class='main-table'>
  <table class='table has-sort-head' id='orgList'>
    <thead>
      <tr>
